...
# MAGIC   FROM nmanchev.pharma.drugs_com 
...
# MAGIC              " ,use0: ",COALESCE(use0,"")) from nmanchev.pharma.medicine where name like concat("%",lower(medicine_name),"%") LIMIT 1
# MAGIC
...
# MAGIC              " ,substitute0: ",COALESCE(substitute0,""))
# MAGIC   from nmanchev.pharma.medicine LIMIT 1
