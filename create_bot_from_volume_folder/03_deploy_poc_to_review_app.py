...
# MAGIC %pip install -U --upgrade databricks-agents mlflow mlflow-skinny databricks-vectorsearch langchain langchain_core langchain_community 
...
chain_input = {
    "messages": [
        {
            "role": "user",
            "content": "What is Allogeneic stem cell transplant used to treat ?", # Replace with a question relevant to your use case
        }
    ]
}
