...
# Use this code to load raw files for custom integration
# Load the raw riles
# raw_files_df = (
...
parsed_files_staging_df = raw_files_df.repartition(7).cache()
parsed_files_staging_df = parsed_files_staging_df.withColumn("parsing", parser_udf("pdf_output"))
