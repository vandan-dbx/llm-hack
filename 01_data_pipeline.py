...
from cookbook.data_pipeline import copy_files
...
copy_files("leaflets/" , source_config.volume_path)

serializable_config_to_yaml_file(source_config, "./configs/uc_source_config.yaml")
...
output_config = DataPipelineOuputConfig(
    ...
    chunked_table_postfix="leaflets_chunked",   # default value is `docs_chunked`
    vector_index_postfix="leaflets_chunked_index", # default value is `docs_chunked_index`
